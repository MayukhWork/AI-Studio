/**
 * Public boundary for @ai3d/plugin-agent-material-lighting.
 *
 ...
 */
export interface MaterialLightingAgentPlugin {
  /**
   * Stable identifier of the package boundary.
   */
  readonly packageId: '@ai3d/plugin-agent-material-lighting';
}
